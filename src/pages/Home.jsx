  ...
  return (
    <>
      ...
      <section className="relative min-h-[70vh] sm:min-h-[90vh] flex items-center justify-center overflow-hidden -mb-1">
        ...
        <div className="absolute -inset-x-0 top-0 -bottom-4" style={{ background: 'linear-gradient(to bottom, transparent 10%, rgba(0,0,0,0.25) 35%, rgba(0,0,0,0.25) 65%, transparent 90%)' }} />
      ...
      {/* Trust Strip */}
      <section className="pt-0 -mt-9 pb-7 sm:mt-0 sm:pt-5 sm:pb-12 px-5 sm:px-6 bg-warm-100 relative z-10">
        <p className="text-[1.35rem] sm:text-4xl text-warm-400 italic font-light tracking-wide text-center mt-[40px] sm:mt-0 mb-4 sm:mb-8" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Experience the Shelby Way</p>
