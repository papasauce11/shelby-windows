    ...
    <>
      ...
      <div className="py-2 sm:py-3 text-center bg-white">
        <a
          ...
          className="inline-flex items-center gap-2 text-warm-500 hover:text-teal-600 transition-colors text-sm font-medium"
        >
      ...
      {/* Instagram promo */}
      <section className="py-12 sm:py-16 px-5 sm:px-6 bg-warm-100 border-t border-warm-200">
