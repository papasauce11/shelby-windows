      ...
      <section className="pt-8 sm:pt-12 pb-12 sm:pb-16 lg:pb-24 px-5 sm:px-6 bg-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div>
            ...
            <span className="text-xs font-heading font-700 uppercase tracking-widest text-teal-600 mb-4 block">Our Story</span>
            ...
            <div className="space-y-5 text-warm-600 text-lg leading-relaxed">
              <p>
                Shelby Windows &amp; Doors Inc. was founded with a straightforward belief: homeowners deserve access to high-quality windows and doors, installed by people who take pride in their work, at a price that makes sense.
              </p>
              <p>
      ...
      <section className="py-12 sm:py-16 lg:py-24 px-5 sm:px-6 bg-warm-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="w-10 h-px bg-teal-600 mb-5 mx-auto" />
            <span className="text-xs font-heading font-700 uppercase tracking-widest text-teal-600 mb-3 block">What Sets Us Apart</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              },
              {
                ...
                description: "Clear pricing, straightforward communication, and no pressure. We give you the information you need to make a confident decision."
              },
              {
                num: "04",
              ...
              <div key={value.num} className="bg-white rounded-2xl p-8 border border-warm-100 hover:border-teal-200 hover:shadow-lg transition-all">
      ...
      <section className="py-12 sm:py-16 lg:py-24 px-5 sm:px-6 bg-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            <div className="w-10 h-px bg-teal-600 mb-5" />
            <span className="text-xs font-heading font-700 uppercase tracking-widest text-teal-600 mb-4 block">Our Team</span>
